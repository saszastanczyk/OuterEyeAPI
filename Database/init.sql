...
CREATE TABLE positions_scan(
    position_scan_id SERIAL,
    user_id INTEGER REFERENCES users(user_id) ON DELETE CASCADE NOT NULL,
...
CREATE INDEX meal_action_idx ON meal_action(action_id);
CREATE INDEX craft_action_idx ON craft_action(action_id);
CREATE INDEX kill_action_idx ON kill_action(action_id);
CREATE INDEX death_action_idx ON death_action(action_id);
CREATE INDEX pray_action ON pray_action(action_id);
...
CREATE INDEX positions_scan_user ON positions_scan(user_id);
CREATE INDEX positions_scan_time ON positions_scan(scan_time DESC);